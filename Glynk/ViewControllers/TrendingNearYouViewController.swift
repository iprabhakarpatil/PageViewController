//
//  TrendingNearYouViewController.swift
//  Glynk
//
...
class TrendingNearYouViewController: UIViewController {


    @IBOutlet weak var webView: UIWebView!
    let movieURL = URL(string: "https://timesofindia.indiatimes.com/city/bangalore")
