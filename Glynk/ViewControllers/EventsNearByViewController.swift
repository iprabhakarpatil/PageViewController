//
//  EventsNearByViewController.swift
//  Glynk
//
...
class EventsNearByViewController: UIViewController {


    @IBOutlet weak var webView: UIWebView!
    let movieURL = URL(string: "https://timesofindia.indiatimes.com/city/bangalore/eventlist/-2128833038.cms?cfmid=10099000")
